...
namespace JintelliBox
{
    ...
    internal class DelegateCommand : ICommand
    {
        ...
        /// <summary> Method to determine if the command can be executed </summary>
        ...
        /// <summary> Execution of the command </summary>
        public void Execute()
        {
        ...
        internal static void RemoveWeakReferenceHandler(List<WeakReference> handlers, EventHandler handler)
        {
            if (handlers != null)
            {
                for (int i = handlers.Count - 1; i >= 0; i--)
                {
                    ...
                    {
                        // Clean up old handlers that have been collected in addition to the handler
